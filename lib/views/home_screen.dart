      ...
      */
      body: Row(
        children: [
          ...
          // LISTA DE NOTAS
          Expanded(
            flex: isMobile ? 1 : 0, //ANCHO FLEXIBLE: EN MOVIL OCUPA TODO
            child: Container(
              width: isMobile ? double.infinity : 350, // ANCHO ADAPTABLE
              clipBehavior: Clip
          ...
          //APARTADO DE EDICIÓN (SÓLO DESKTOP)
          if (!isMobile)
            Expanded(
              child: Container(
